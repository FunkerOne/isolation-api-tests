...
class MockLoader:
    ...
    async def load_http[HTTPModelT: BaseModel](self, file: str, model: Type[HTTPModelT]) -> HTTPModelT:
        """
    ...
    async def load_grpc[GRPCModelT: Message](self, file: str, model: Type[GRPCModelT]) -> GRPCModelT:
        """
